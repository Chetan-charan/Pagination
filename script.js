...
function displayUsers(current_page,y)
{
  
  let start = 10*(current_page-1);
  let end = start + 10;
  let page_users = users.slice(start,end);

  document.body.innerHTML = `<table class="table"><thead>
  <tr>
  <th scope="col">Id</th>
  <th scope="col">Name</th>
  <th scope="col">Email</th>
  </tr>
  </thead><tbody class='body'></tbody></table><div>
  <nav aria-label="Page navigation example">
    <ul class="pagination">
        <li class="page-item"><a class="page-link"  onclick="render(1)">First</a></li>
        <li class="page-item"><a class="page-link"  onclick="render(${y})">Previous</a></li>
        <li class="page-item"><a class="page-link"  onclick="render(2)">2</a></li>
        <li class="page-item"><a class="page-link"  onclick="render(3)">3</a></li>
        <li class="page-item"><a class="page-link"  onclick="render(4)">4</a></li>
        <li class="page-item"><a class="page-link"  onclick="render(5)">5</a></li>
        <li class="page-item"><a class="page-link"  onclick="render(6)">6</a></li>
        <li class="page-item"><a class="page-link"  onclick="render(7)">7</a></li>
        <li class="page-item"><a class="page-link"  onclick="render(8)">8</a></li>
        <li class="page-item"><a class="page-link"  onclick="render(9)">9</a></li>
        <li class="page-item"><a class="page-link"  onclick="render(10)">10</a></li>
    </ul>
</nav>
</div>`
  ...
  page_users.forEach(user => {
    tableBody.innerHTML+=`<tr><td>${user.id}</td><td>${user.name}</td><td>${user.email}</td></tr>`
  });
  
}

let page_users = users.slice(0,10);
document.body.innerHTML = `<table class="table"><thead>
<tr>
<th scope="col">Id</th>
<th scope="col">Name</th>
...
</thead><tbody class='body'></tbody></table>
<div>
  <nav aria-label="Page navigation example">
    <ul class="pagination">
        <li class="page-item"><a class="page-link"  onclick="render(1)">First</a></li>
